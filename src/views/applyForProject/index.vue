<template>
  <div>
    ...
    <van-cell title-class="cell-t" label="自到账以后三个工作日后可提取" title="来款日期" :value="formData.arrivalTime" @click="showFlag = true;" is-link />
    ...
    <van-calendar title="选择来款时间" v-model="showFlag" @confirm="onConfirm" />
  </div>
</template>

<template>
  <div>
    ...
    <van-cell title-class="cell-t" label="自到账以后三个工作日后可提取" title="工资款到账时间" :value="formData.arrivalTime" @click="showFlag = true;" is-link />
    ...
    <van-calendar title="选择工资款到账时间" v-model="showFlag" @confirm="onConfirm" />
  </div>
</template>
